$(function () {
    ...
    function getTopVolume(limit) {
        var url = baseUrl + '/dealer/chart/sales/volume/' + limit;
    ...
    function getTopAmount(limit) {
        var url = baseUrl + '/dealer/chart/sales/amount/' + limit;
    ...
    function getAllSalesCommissionByMonth(year, month) {
        ...
        var url = baseUrl + '/dealer/chart/sales/commission/' + year + "/" + month;
