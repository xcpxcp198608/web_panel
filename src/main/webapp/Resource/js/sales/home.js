$(function () {
     ...
     */
    getSalesCommissionEveryDayInMonth(currentYear, currentMonth);
    function getSalesCommissionEveryDayInMonth(year, month) {
        var days = getDaysOfYearAndMonth(year, month);
        var url = baseUrl + "/sales/chart/commission/" + year + "/" + month;
    ...
    function getDealerVolumeEveryDayInMonth(year, month) {
        var days = getDaysOfYearAndMonth(year, month);
        var url = baseUrl + "/sales/chart/volume/" + year + "/" + month;
        $('#btPreviousMonth').attr('disabled', 'disabled');
        $('#btNextMonth').attr('disabled', 'disabled');
