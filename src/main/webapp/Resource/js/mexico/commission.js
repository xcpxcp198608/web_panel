$(function () {
    ...
    function getSalesAmountEveryMonthInYear(year){
        var url = baseUrl + "/mexico/chart/amount/"+ year;
        $.get(url, {}, function (dataList, status) {
            ...
            tbYearIncome.rows[5].cells[1].innerHTML = yearTotalSvcCharge.toFixed(2);
            tbYearIncome.rows[6].cells[1].innerHTML = yearTotalTxFee.toFixed(2);
            tbYearIncome.rows[7].cells[1].innerHTML = yearTotalActivation.toFixed(2);
            tbYearIncome.rows[8].cells[1].innerHTML = yearTotalLdActivationComm.toFixed(2);
            tbYearIncome.rows[9].cells[1].innerHTML = yearTotalLdeActivationComm.toFixed(2);
            tbYearIncome.rows[10].cells[1].innerHTML = yearTotalDealerActivationComm.toFixed(2);
            yearIncomeChart.setOption(yearIncomeChartOption);
        })
    }
    ...
    function refreshData() {
        ...
        for(var i = 0; i < items; i ++){
            ...
            var svc = tbIncome.rows[5].cells[i+2].innerHTML;
            svcData.push(svc);
            var tx = tbIncome.rows[6].cells[i+2].innerHTML;
            txData.push(tx);
            var activation = tbIncome.rows[7].cells[i+2].innerHTML;
            activationData.push(activation);
            var ldA = tbIncome.rows[8].cells[i+2].innerHTML;
            ldAData.push(ldA);
            var ldeA = tbIncome.rows[9].cells[i+2].innerHTML;
            ldeAData.push(ldeA);
            var dealerA = tbIncome.rows[10].cells[i+2].innerHTML;
    ...
    function getSalesAmountEveryDayInMonth(year, month) {
        var url = baseUrl + "/mexico/chart/amount/" + year + "/" + month;
        ...
        $.get(url,{ },function(dataList, status){
            ...
            tbIncome.rows[5].cells[1].innerHTML = totalMonthSvcCharge.toFixed(2);
            tbIncome.rows[6].cells[1].innerHTML = totalMonthTxFee.toFixed(2);
            tbIncome.rows[7].cells[1].innerHTML = totalMonthActivatePay.toFixed(2);
            tbIncome.rows[8].cells[1].innerHTML = totalMonthLdActivationComm.toFixed(2);
            tbIncome.rows[9].cells[1].innerHTML = totalMonthLdeActivationComm.toFixed(2);
            tbIncome.rows[10].cells[1].innerHTML = totalMonthDealerActivationComm.toFixed(2);
            refreshData();
            monthIncomeChart.setOption(monthIncomeChartOption);
