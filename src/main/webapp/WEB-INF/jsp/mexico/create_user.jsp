...
<rapid:override name="css_js">
    <script type="application/javascript" src="Resource/js/mexico/create_user.js"></script>
</rapid:override>
            ...
            <div>
                ...
                <table class="table table-sm table-hover table-striped table-dark" id="tbCategory">
                    ...
                    <c:forEach items="${commissionCategoryInfoList}" var="commissionCategoryInfo">
                        <tr>
                            <td><input type="radio" name="categoryRadio" value="${commissionCategoryInfo.category}" checked></td>
