...
<rapid:override name="css_js">
    <script type="application/javascript" src="Resource/js/mexico/commission.js"></script>
</rapid:override>
            ...
            <table class="table table-sm table-hover table-striped table-dark" id="tbCategory">
                <thead>
                    <tr><td>#</td><td>Price</td><td>Expires</td><td>Bonus</td>
                        ...
                        <td>LD</td><td>LDM</td><td>Dealer</td>
                        <td>Activation</td><td>LD-A</td><td>LDM-A</td>
                        <td>Dealer-A</td>
                    </tr>
                </thead>
                <tbody>
                    <c:forEach items="${commissionCategoryInfoList}" var="commissionCategoryInfo">
                        <tr>
                            ...
                            <td style="color: #ffcafb">${commissionCategoryInfo.deposit}</td>
                ...
                <div style="padding: 20px 20px 0 20px ; overflow: scroll">
                    <table class="table table-sm table-hover table-striped table-dark" id="tbYearIncome">
                        <tbody>
                            ...
                            <tr><td>Deposit</td><td style="font-style: italic; color: #ffcafb">0</td></tr>
                            <tr><td>LD</td><td style="font-style: italic; color: greenyellow">0</td></tr>
                            <tr><td>LDM</td><td style="font-style: italic; color: greenyellow">0</td></tr>
                            ...
                            <tr><td>LDM-A</td><td style="font-style: italic; color: #0676f1">0</td></tr>
        ...
        <div style="padding: 0 20px 10px 20px; overflow: scroll">
            <table  class="table table-sm table-hover table-striped table-dark" id="tbMonthIncome">
                ...
                <tbody>
                    ...
                    <tr><td>LDM</td><td class="text-warning">0</td></tr>
                    ...
                    <tr><td>LDM-A</td><td class="text-primary">0</td></tr>
